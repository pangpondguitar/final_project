...
<div class="row">
                ...
                <div class="col-lg-4 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
                    <div class="nav-wrapper position-relative end-0">
                        <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                            ...
                            <div class="moving-tab position-absolute nav-link" aria-selected="false" tabindex="-1" role="tab" style="padding: 0px; width: 95px; transform: translate3d(0px, 0px, 0px); transition: all 0.5s ease 0s;"><a class="nav-link mb-0 px-0 py-1 active " data-bs-toggle="tab" href="javascript:;" role="tab" aria-selected="true">-</a></div>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="col-lg-12">
        ...
        <div class="card mt-4" id="password">
            ...
            <div class="card-body pt-0">
                <form action="{{ route('admin.user_edit_password', $data->user->id)}}" method="POST">
                    @csrf
                    <label class="form-label">รหัสผ่าน</label>
                    <div class="form-group">
                        <input class="form-control" type="password" placeholder="Current password" value="............." readonly>
                    </div>

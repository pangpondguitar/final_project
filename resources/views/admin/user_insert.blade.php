    ...
    <div class="col-lg-12 mt-lg-0 mt-4">
        ...
        <div class="card mt-4" id="basic-info">
            ...
            <div class="card-body pt-0">
                <form action="{{ route('admin.user_insert_check')}}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-6">
                            <label class="form-label ">ชื่อ-นามสกุล</label>
                            <div class="input-group">
                                <input id="firstName" name="name" class="form-control" type="text" placeholder="ป้อนชื่อ-นามสกุล" onfocus="focused(this)" onfocusout="defocused(this)" id="validationCustom01">
                            </div>
                            @error('name')
                            <div class=" my-2">
                        ...
                        <div class="col-6">
                            ...
                            <div class="input-group">
                                <input id="lastName" name="name2" class="form-control" type="text" placeholder="ป้อนชื่อ-นามสกุล(ภาษาอังกฤษ)" required="required" onfocus="focused(this)" onfocusout="defocused(this)">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="input-group">
                                <input id="email" name="username" class="form-control" type="text" placeholder="ป้อนชื่อบัญชีผู้ใช้" onfocus="focused(this)" onfocusout="defocused(this)">
                            </div>
                        </div>
                        <div class="col-6">
                            <label class="form-label mt-4">รหัสผ่าน(password)</label>
                            <div class="input-group">
                                <input id="confirmation" name="password" class="form-control" type="text" placeholder="ป้อนรหัสผ่าน" onfocus="focused(this)" onfocusout="defocused(this)">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row d-flex text-end mt-3">
                        <div class="col-lg-12">
                            ...
                            <button class="btn bg-gradient-primary mb-0 px-5" type="submit" name="button">บันทึกข้อมูล</button>
                        </div>
                    </div>
                </form>
            </div>

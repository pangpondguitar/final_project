...
const Confirm_status = (status_con) => {
    const dfIds = docfile.value.map((item) => item.df_id);
    console.log(status_con);
    Swal.fire({
        ...
        if (result.value) {
            axios
                .get(`/api/admin_confirm_docfile_status/${dfIds}/${status_con}`)
                .then(() => {
                    Swal.fire(
                        "Confirm ",
        ...
        <div class="col-lg-6">
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    >
                        <li
                            class="list-group-item d-flex align-items-center px-0 mb-2 border-0"
            ...
            <div class="card h-100">
                ...
                <div class="card-body pb-2 t">
                    ...
                    <div class="row" v-if="docfile.length == 0">
                        <div class="col-lg-12">
                            <div
                                class="card bg-light text-center card-empty-doc mb-3"
                            >

...
const getSubject = async (page = 1) => {
    try {
        let response = await axios.get(
            `/api/president_get_subjectAll_term/${props.id}/${currentTerm.value}/?page=${page}`
        );
        ...
        <div class="col-lg-12">
            <div class="card p-1">
                <div class="card-body pt-4">
                    <h4
                        class="mt-lg-0 mt-4 pb-0 mb-0 text-primary text-gradient"
                    >
                        รายงานการจัดส่ง มคอ. {{ program.p_name }}
                    </h4>
                ...
                <div class="table-responsive">
                    <table class="table align-items-center mb-0 table-hover">
                        <thead>
                            <tr>
                                <th
                                    class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 td-doc th-1"
                                >
                                    รายวิชา
                                </th>
                            ...
                            >
                                <td>
                                    <div class="d-flex px-3">
                                        ...
                                        >
                                            <h6
                                                class="mb-0 fw-semibold text-sm"
                                            >
                                                {{ items.subjects.s_name }}
                                            </h6>
                                            <p
                                                class="text-sm fw-normal text-secondary text-sm mb-0"
                                            >
                                                รหัสวิชา
                                                <span class="">{{

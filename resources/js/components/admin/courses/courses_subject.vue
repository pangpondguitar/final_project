        ...
        <div class="modal-dialog  modal-lg">
            <div class="modal-content">
                        ...
                        <div class="d-flex  justify-content-start mt-3">
                            <div class="form-check me-2">
                                <input class="form-check-input" type="radio" name="flexRadioDefault2" id="flexRadioDefault5"
                                    value="1" checked v-model="formAdd.doc_type">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="flexRadioDefault2" id="flexRadioDefault6"
                                    v-model="formAdd.doc_type" value="2">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" @click="saveSubject()">บันทึกข้อมูล</button>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="d-flex justify-content-between">
                    <div>
                        <a href="" class="btn btn-danger " data-bs-toggle="modal"
                            data-bs-target="#exampleModal">เพิ่มรายวิชา + </a>
                    </div>
                    <div>
                        ...
                        <tr v-for="item in subjects.data" :key="item.id">
                            ...
                            <td class="align-middle text-center">
                                ...
                                <a class="text-danger font-weight-bold ms-4" data-toggle="tooltip"
                                    @click="delete_subject(item.s_id, item.s_name)">
    ...
    <div class="modal fade" id="edit" tabindex="-1" aria-labelledby="edit" aria-hidden="true" @hidden="onModalHidden">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                        ...
                        <div class="d-flex  justify-content-start mt-3">
                            <div class="form-check me-2">
                                <input class="form-check-input" type="radio" name="flexRadioDefault1" id="flexRadioDefault3"
                                    value="1" v-model="form.doc_type" :checked="form.doc_type === '1'">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">ปิด</button>
                    <button type="submit" class="btn btn-primary" @click="editSubject(form.s_id)">บันทึกข้อมูล</button>
                </div>
            </div>
        </div>
    </div>

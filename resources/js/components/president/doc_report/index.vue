        ...
        <div class="col-lg-12">
            <div class="card p-1">
                <div class="card-body pt-3">
                    <h5 class="mt-lg-0 mt-4 pb-0 mb-0   text-dark text-gradient ">รายงานการจัดส่ง มคอ.</h5>
            ...
            <div class="card mt-3">
                ...
                <div class="table-responsive">
                    <table class="table align-items-center mb-0 table-hover">
                        ...
                        <tbody>
                            <tr v-for="items in subjects.data" :key="items.ts_id">
                                <td>
                                    <div class="d-flex px-3 ">

                                        <div class="d-flex flex-column justify-content-center">
                                            <h6 class="mb-0 fw-semibold fw-normal">{{ items.subjects.s_name }}</h6>
                                ...
                                <td class="align-middle text-center text-sm">
                                    ...
                                    <div v-else>
                                        <span class="badge bg-gradient-danger">no documents</span>
                                    </div>
                                </td>
                                ...
                                <td class="align-middle text-center">
                                    <div>
                                        ...
                                        <button class="btn bg-gradient-dark shadow btn-sm mb-0"
                                            @click="Subject_detail(items.ts_id)">ดูรายละเอียด</button>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
                ...
                <div class="container mt-2 ">
                    <Bootstrap5Pagination :data="subjects" @pagination-change-page="getSubject
                                        " />
                </div>
            </div>
        </div>

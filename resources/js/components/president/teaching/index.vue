...
const get_Teacher = async () => {
    try {
        ...
        let response = await axios.get(
            `/api/president_get_teacher/${User_pId.value}/${currentTerm.value}`
        );
...
const Teaching_detail = (id) => {
    router.push(
        `/president/teaching/teaching_detail/${id}/${currentTerm.value}`
    );
};
            ...
            <div class="card p-1">
                <div class="card-body pt-3">
                    ...
                    <div class="row">
                        ...
                        >
                            <div
                                class="card text-start card-teacher-detail"
                                @click="Teaching_detail(item.id)"
                            >
                                <div
                                ...
                                <div class="card-body">
                                    ...
                                    <p
                                        class="category text-secondary py-0 text-sm"
                                    >
                                    ...
                                    <div class="col-12 py-3 ps-0">
                                        ...
                                        <h4 class="font-weight-bolder">
                                            ...
                                            <span class="fs-5 ms-1">วิชา</span>
                                        </h4>

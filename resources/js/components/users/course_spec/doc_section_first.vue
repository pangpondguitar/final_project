    ...
    <div class="col-lg-9">
        <div class="card" id="basic-info">
            ...
            <div class="card-body pt-0">
                ...
                <div class="row">
                    <h6 for="" class="mt-4 mb-0">
                        ชื่อหลักสูตรและประเภทของรายวิชา
                    </h6>
                </div>
                <div class="row mt-1">
                    <div class="col-5">

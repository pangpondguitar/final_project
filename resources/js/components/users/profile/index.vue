...
const get_profile = async () => {
    try {
        let response = await axios.get(`/api/get_profile/2`);
...
<template>
    <div class="row" id="element-to-convert">
        <button class="btn btn-danger" @click="exportToPdf()">ส่งออกไฟล์ PDF</button>
        <div class="col-lg-12">
                    ...
                    <div class="col-lg-4 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
                        <div class="nav-wrapper position-relative end-0">
                            <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                                ...
                                <div class="moving-tab position-absolute nav-link" aria-selected="false" tabindex="-1"
                                    role="tab"
                                    style="padding: 0px; width: 95px; transform: translate3d(0px, 0px, 0px); transition: all 0.5s ease 0s;">
                                    <a class="nav-link mb-0 px-0 py-1 active " data-bs-toggle="tab" href="javascript:;"
                ...
                <div class="card-body pt-0">
                    <form action="" method="POST">
                            ...
                            <div class="col-5">
                                ...
                                <div class="input-group">
                                    <input id="firstName" name="name" class="form-control" type="text"
                                        placeholder="ป้อนชื่อ-นามสกุล" required="required" v-model="form.name">
                                </div>
                            </div>
                            <div class="col-4">
                                ...
                                <div class="input-group">
                                    <input id="lastName" name="name2" class="form-control" type="text"
                                        placeholder="ป้อนชื่อ-นามสกุล(ภาษาอังกฤษ)" required="required" v-model="form.name2">
                                </div>
                            </div>
                            <div class="col-3">
                                <label class="form-label">สาขา</label>
                                <div class="input-group">
                                    <input id="lastName" name="name2" class="form-control" type="text" placeholder=""
                                        required="required" v-model="form.program" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row d-flex text-end mt-3">
                            <div class="col-lg-12">
                                <a class="btn bg-outline-secondary mb-0 px-5 me-2" href="">กลับ</a>
                ...
                <div class="card-body pt-0">
                    <form action="" method="POST">
                        ...
                        <div class="form-group">
                            <input class="form-control" type="password" placeholder="Current password" value="............."
                                readonly>
                        </div>
                        ...
                        <div class="row d-flex text-end mt-3">
                            <div class="col-lg-12">
                                <a class="btn bg-outline-secondary mb-0 px-5" href="">กลับ</a>
                                <button class="btn bg-gradient-primary mb-0 px-5" type="submit">บันทึกข้อมูล</button>
                            </div>
                        </div>
                    </form>
